...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare('SELECT * FROM users WHERE username=? AND status=? AND deleted_at IS NULL LIMIT 1');
                ...
                <div class="card my-5">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-end mb-4">
                            ...
                            <a href="/auth/register.php" class="link-primary">Belum punya akun?</a>
                        </div>
